...
REM
REM Generated by Vivado on Mon May 02 14:45:19 +0700 2022
...
echo "xvlog --incr --relax -prj FIFO_v_tb_vlog.prj"
call xvlog  --incr --relax -prj FIFO_v_tb_vlog.prj -log xvlog.log
